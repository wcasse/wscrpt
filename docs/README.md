...
| Doc | What it covers |
| --- | --- |
| [../AGENTS.md](../AGENTS.md) | Model-agnostic agent instructions for any automated assistant (gates, house rules, no push/tag by default) |
...
| [MAINTAINER_OPS.md](MAINTAINER_OPS.md) | How Will + agents run the public repo: labor split, lanes, release ceremony, playbooks |
